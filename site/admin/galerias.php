...
<div class="container">
	<h3>Galerias: </h3>
	<a href='novaGaleria.php'><button class="btn btn-default">Adicionar Galeria</button></a><hr>
		...
		<?php
			...
			while($dados = $consulta->fetch(PDO::FETCH_OBJ)){
				...
				echo "<tr>
					      ...
					      <td>
					      	<a href='novaGaleria.php?id=$id'><button class='btn negrito'>Editar</button></a>
					      	<a href='galeria.php?id=$id'><button class='btn btn-danger negrito'>Excluir</button></a>
					      </td>	
					  </tr>";
			}
		?>
